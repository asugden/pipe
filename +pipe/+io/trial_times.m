...
%   of trial types, takes a monkey logic file
    ...
    nametable = { ...
        ...
        'csm_2s_cond_delay_jz.m', 'minus', ...
        'csm_2s_cond_jz.m', 'minus', ...
        'csm_2s_pav_delay_jz.m', 'pavlovian_minus', ...
        'csp_2s_cond_delay_jz.m', 'plus', ...
        'csp_2s_cond_jz.m', 'plus', ...
        'csp_2s_pav_delay_jz.m', 'pavlovian', ...
        'csm_2s_pav_jz.m', 'pavlovian', ...
        'csp_2s_catch_jz.m', 'catch', ...
        'csn_2s_jz.m', 'neutral', ...
        'blank_2s_jz.m', 'blank', ...
        'blank_2s_punish_jz.m', 'blank_punish', ...
        'blank_2s_reward_jz.m', 'blank_reward', ...
        'csmix_cond_2s_end.m', 'mixed', ...
        'csmix_cond_2s_plus.m', 'mixed_plus', ...
        'pavlovian_csm_shock.m', 'pavlovian_minus', ...
    };
...
%   of trial types, takes a monkey logic file
    ...
    nametable = { ...
        ...
        'Mov(Mov_0,0,0)', 0, ...
        'Mov(0deg_FF,0,0)', 0, ...
        'Mov(0deg_FF_primetime,0,0)', 0, ...
        'Mov(0deg_topL,0,0)', 0, ...
        'Mov(135deg_FF,0,0)', 135, ...
        'Mov(135deg_FF_primetime,0,0)', 135, ...
        ...
        'Mov(270deg_FF_primetime,0,0)', 270, ...
    ...
    for i = 1:length(ml.TaskObject)
        if sum(ml.ConditionNumber == i) > 0
            ...
            for k = 1:npossibles
                for j = 1:nnames
                    if found < 0
                        if strcmpi(ml.TaskObject{i, k}, nametable{j*2 - 1})
